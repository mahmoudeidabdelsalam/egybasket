            ...
            <div class="container cont-h">
                ...
                <div class="list-slider">
                  ...
                  <!--  <a href="">امس </a>-->
                     ...
                     <a class="a-slider2"href="<?= get_option('sh_home_all_matches_link'); ?>">اليوم</a>
 ...
 -->                  </div>
                ...
                <div class="all-almubara">
                  ...
                  <div class="titl-even">
                    ...
                    <a  href="<?= get_option('sh_home_all_matches_link'); ?>">
                 ...
                 <div id="carouselExampleControls" class="carousel slide" data-ride="carousel"> 
                  ...
                  <?php $today_matches = sh_get_matches(-1,date('j/n/Y')); $matches_today_num = $today_matches->found_posts;?>
                ...
                <?php while ( $latest_news_home->have_posts() ) : $latest_news_home->the_post(); $postId=get_the_ID(); ?>
                  ...
                  <div class="component-events-right text-right ">
                    ...
                    <div class="card mb-3">
                      ...
                      <img src="<?= get_the_post_thumbnail_url($postID,'medium'); ?>" alt="<?php the_title(); ?>" class="main_news_img">
                  ...
                  <?php $j=1; while ( $latest_news_home->have_posts() ) : $latest_news_home->the_post(); $postId=get_the_ID(); ?>
                      ...
                      <div class="card sh_card">
                        ...
                        <img src="<?= get_the_post_thumbnail_url($postID,'medium'); ?>" class="card-img-top" alt="<?php the_title(); ?>">
         ...
         <div class="component-content text-right">
            ...
            <div class="content-right ">
                ...
                <div class="component-video-direct">
                  ...
                  <?php echo get_option('sh_home_straming_link'); ?>                  
                 ...
                 <div class="component-latest-news">
                  ...
                  <div class="component-title-link">
                   ...
                   <?php $home_videos = sh_get_videos(33,4); ?>
                    ...
                    <div class="WhyUsVideo">
                      ...
                      <div class="list-group-1" id="v1">
                        ...
                        <video id="exampleVideo1" >
                            ...
                            <source src="<?= get_post_meta( $videoId, 'sh_video_link', true ); ?>" type="video/mp4">
                  ...
                  <?php while ( $home_videos->have_posts() ) : $home_videos->the_post(); $postId=get_the_ID(); ?>
