...
get_header(); ?>
<style type="text/css">
  .component-tarikh-alaitihad{padding-top:80px;}
</style>
<header>
    ...
    <div class="tab-pane active show" id="tab-faq-1">
       ...
       <?php if ( $maglis_managers->have_posts() ) : ?>
        ...
        <?php while ( $maglis_managers->have_posts() ) : $maglis_managers->the_post(); ?>
         <a href="<?php the_permalink(); ?>" class="media sh_media_block">
          ...
          <img src="<?= get_the_post_thumbnail_url(get_the_ID(),'medium');?>" class="ml-3 sh_manager_img_main" alt="<?php the_title(); ?>" >
     ...
     <div class="component-list-lajnah  text-right">
      ...
      <div class="modal-lanah2 row">
       ...
       <?php $maglis_managers = sh_get_managers_except(-1,11); ?>
     ...
     <div class="tab-pane " id="tab-faq-2">
      ...
      <div class="component-list-lajnah">
       ...
       <?php $years = sh_get_years_of_mangers(); ?>
        ...
        <div class="component-injazat-left col-md-12">
         ...
         <?php $i=0; foreach ($years as $year) {  ?>
          ...
          <div class="tab-paneactive show col-md-4 col-sm-12 sh_manager_year" id="tab-faqy-<?= $year->term_id; ?>">
           ...
           <div class="media-ruasa mb-4">
              ...
              <div class="media-body">
                ...
                <h5 class="mt-0 mb-1"><?php the_title(); ?></h5>
                <h6 class="span-media"><?php the_content(); ?></h6>
                <h4 class="span-media"><?php echo $year->name; ?></h4>
            ...
            <div class="carde card-asked">
              ...
              <div class="card-header" id="headingOne">
                  ...
                  <h2 class="mb-0">
                      ...
                      <div  class="btn  card-Frequently" data-toggle="collapse" data-target="#collapse<?= $child->term_id; ?>">
              ...
              <div id="collapse<?= $child->term_id; ?>" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">

                <div class="card-body">
       <div class="component-list-lajnah row text-right">

         <div class="modal-lanah2 row" style="grid-template-columns:1fr 1fr;">
