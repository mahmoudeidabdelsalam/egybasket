        ...
        <form method="post" action="#" enctype="multipart/form-data">
          <div class="box-body">
            <div class="form-group">
              <label for="file">Choose Csv File to import judges from (.csv)<span class="red_star">&nbsp;&nbsp;*</span></label>
          ...
          <div class="box-footer">
            <input type="submit" class="btn btn-primary btn-lg margin-center" name="submit_file" value="Import Judges">
          </div>
        </form>
      </div>
      <!-- /.box -->
