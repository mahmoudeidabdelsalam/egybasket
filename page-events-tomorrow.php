<?php 
/**
** Template Name: Tomorrow Events Template
**/
get_header(); ?>
	...
	<div class="container cont-h">
                ...
                <div class="all-almubara">
                 ...
                 <div id="carouselExampleControls" class="carousel slide" data-ride="carousel"> 
                  ...
                  <?php $today_matches = sh_get_matches(-1,$tomorrow); $matches_today_num = $today_matches->found_posts;
                  ...
                  <?php if( ($k%4 == 0) || ($k == $matches_today_num ) ) {  ?>
