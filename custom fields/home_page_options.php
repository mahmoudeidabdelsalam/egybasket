	...
	<div class="row">
		<div class="col-md-12">
			...
			<header class="codrops-header">
				<br>
				<h1 class="text-center sh-title">Home Page Options</span></h1>
				<br>
			</header>
		</div>
	</div>
	<div class="row">
		<div class="col-sm-3" style="margin:0px;">
			<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
				<a class="nav-link active" id="v-pills-firstsection-tab" data-toggle="pill" href="#v-pills-firstsection" role="tab" aria-controls="v-pills-firstsection" aria-selected="true">Home Options</a>
			</div>
		</div>
